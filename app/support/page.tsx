      ...
      <div className = "bg-gray">
        <div className = "section container">
          ...
          <div>
            ...
            <div className={`brand-border ${styles.crab}`}>
              <h2>Crab</h2>
            ...
            <div className={`brand-border ${styles.lobstah}`}>
              <h2>Lobstah</h2>
            ...
            <div className={`brand-border ${styles.blue}`}>
              <h2>Blue Lobstah</h2>
